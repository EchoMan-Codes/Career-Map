...
const FIELD_DATA = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          "Hyperlink Text Management Links",
    ...
    roadmap: [
      {
        id: 1,
        title: "HTML Mastery",
        desc: "Semantic tags, forms, and accessibility structures.",
      },
      {
        id: 2,
        title: "CSS Layouts",
        desc: "Flexbox, Grid, and Responsive Web Design techniques.",
      },
      {
        id: 3,
        title: "JavaScript Logic",
        desc: "ES6+ features, fetch API, and DOM manipulation.",
      },
      {
        id: 4,
        title: "React.js",
      ...
      },
      {
        ...
        desc: "Express servers, REST APIs, and database basics.",
      },
    ],
    jobs: [
      {
    ...
    roadmap: [
      {
        ...
        desc: "Linear algebra, calculus, and probability.",
      },
      {
        id: 2,
        title: "Python Programming",
        desc: "NumPy, Pandas, and basic data structures.",
      },
      {
        id: 3,
        title: "Machine Learning",
        desc: "Supervised and unsupervised learning basics.",
      },
      {
        id: 4,
        title: "Deep Learning",
        desc: "Neural networks with TensorFlow or PyTorch.",
      },
      {
        id: 5,
        title: "NLP & Computer Vision",
        desc: "Advanced AI applications and libraries.",
      },
    ],
    jobs: [
      {
  ...
  "data-science": {
    ...
    roadmap: [
      {
        id: 1,
        title: "Statistics Dasar",
        desc: "Understanding distributions and hypothesis testing.",
      },
      {
        id: 2,
        title: "Python for Data",
        desc: "Pandas, NumPy, and Scikit-learn Mastery.",
      },
      {
        id: 3,
      ...
      },
      {
        ...
        desc: "Building dashboards with Tableau or Matplotlib.",
      },
      {
        id: 5,
        title: "Advanced Analytics",
        desc: "Big Data tools and Predictive Modeling.",
      },
    ],
    jobs: [
      {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          "A sport",
          "A network protocol",
          "A deceptive email trick",
          "A fast computer chip",
        ],
        correct: 2,
      },
      {
    ...
    roadmap: [
      {
        ...
        desc: "TCP/IP, DNS, and HTTP/S protocols.",
      },
      {
        id: 2,
        title: "Security Principles",
        desc: "CIA Triad, Encryption, and Access Control.",
      },
      {
        id: 3,
        title: "Linux Mastery",
        desc: "Command line focus and shell scripting.",
      },
      {
        id: 4,
      ...
      },
      {
        ...
        desc: "Digital forensics and threat hunting.",
      },
    ],
    jobs: [
      {
...
const RESOURCES = [
  {
    ...
    desc: "Learn the essentials of HTML5 in one hour.",
    type: "Video",
  },
  {
    title: "Modern CSS Guide",
    desc: "A complete handbook for CSS Flexbox and Grid.",
    type: "Guide",
  },
  {
    title: "JS Fundamentals",
    desc: "Master variables, functions, and arrays.",
    type: "Course",
  },
  {
    title: "AI Ethics 101",
    desc: "Exploring the social impact of AI.",
    type: "Guide",
  },
  {
    title: "Cyber Defense Basics",
    desc: "Protect yourself from online threats.",
    type: "Video",
  },
  {
    title: "Data Cleaning Tips",
    desc: "How to handle messy data effectively.",
    type: "Course",
  },
  {
    title: "Advance React Patterns",
    desc: "Build scalable apps with hooks and context.",
    type: "Course",
  },
  {
    title: "Network Security",
    desc: "Deep dive into firewalls and encryption.",
    type: "Guide",
  },
];
...
const EXTRA_SKILLS = [
  { title: "GitHub Mastery", desc: "Learn version control and collaboration." },
  {
    ...
    desc: "Build a stunning showcase for your work.",
  },
  {
    title: "Technical Writing",
    desc: "Document your code like a professional.",
  },
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const renderDashboard = () => {
    document.getElementById("knowledge-score").innerText =
      userProfile.displayScore;
    ...
    document.getElementById("remaining-topics").innerText =
      totalRoadmapSteps - completed;
  };
  ...
  const renderJobs = (jobsData) => {
    ...
    if (!jobsData || jobsData.length === 0) {
      jobsGrid.innerHTML =
        '<p class="no-data">No jobs found matching your criteria.</p>';
      return;
    }

    jobsGrid.innerHTML = jobsData
      .map(
        (job) => `
  ...
  const renderResources = () => {
    ...
    resourcesGrid.innerHTML = RESOURCES.map(
      (res) => `
  ...
  const renderExtraSkills = () => {
    ...
    extraGrid.innerHTML = EXTRA_SKILLS.map(
      (skill) => `
